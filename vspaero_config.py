...
WAKE_NUM_ITER  = 36      # Only settable for pseudo-steady total itterations unsteady max iterations per time step
NCPU           = 8
...
NUM_WAKE_NODES =  64# ensures none of the wake is discarded
...
ANALYSIS_BASE_NAME = "Hover_analysis_TM_5315"
